...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        //saves all meals data before closing
        let rootVC = UIApplication.shared.keyWindow?.rootViewController as! UINavigationController?
        let MealsTableVC = rootVC?.viewControllers[0] as! MealsTableViewController?
        MealsTableVC?.archiveData()
    }
